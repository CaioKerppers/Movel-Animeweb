...
export class SigninPage implements OnInit {
  ...
  public LogarAnonimo() : void{
    this.authService.signInAnonymously().then((userCredential) => {
      // Lida com o sucesso do login anônimo, se necessário
      const user = userCredential.user;
      console.log('Usuário anônimo logado:', user);
    }).catch((error) => {
      // Lida com erros durante o login anônimo
